...
% present locally for private author metadata). The file is gitignored and an
% example template `author_config.example.tex` may be provided for contributors.
\IfFileExists{author_config.tex}{%
	\input{author_config.tex}%
}{%
	\providecommand{\authorname}{Dawson Institute}%
	\providecommand{\authoraffiliation}{Dawson Institute}%
	\providecommand{\authoremail}{info@dawsoninstitute.org}%
}

\author{\authorname\\
  \textit{\authoraffiliation}\\
  \texttt{https://github.com/DawsonInstitute}}
